...
- Completed P0/Tier-1 components: Gate 0, quarantine, tests, corrected full GARQ D5/D11/D17/D18 ×3 seeds, requested-K matched official SEACells/MetaQ and KMeans ×3 seeds (48/48 common-evaluator passes), official EpiCarousel full D11/D17, combined size/per-type summaries, and the R2 Minor 4 Figure 4b frozen-assignment Mast analysis under the author-approved same-compression/non-exact-K rule.
...
Read `PHASE2_EXPERIMENT_REPORT.md`, `REVIEWER_EVIDENCE_MATRIX_PHASE2.md`, `R2_MINOR4_FIG4B_MAST_REPORT.md`, audit tables, `01_size_resolution/*.csv`, `08_scalability/stage_profile.csv`, `fig4b/reviewer_mast_quantification/`, failures and the manifest. Large assignments and raw data are intentionally excluded from Git/bundle.
